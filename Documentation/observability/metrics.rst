...
``service_implementation_delay``           ``scope``, ``action``                              Enabled    Duration in seconds to propagate the programming of a service, its network and endpoints from the time the service or the service pod was changed
========================================== ================================================== ========== ========================================================
